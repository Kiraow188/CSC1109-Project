...
public class MainAtmCli {
    ...
    public static void showCustomerMenu(String accNum, String pin, String userId) throws Exception {
        ...
        System.out.println("  ----------------------------------");
        System.out.printf("  | Saving Account No.: %s  |\n", SAaccNo);
        System.out.printf("  | Saving Balance: $%.2f          |\n", savingsBalance);
        System.out.println("  ----------------------------------");
        System.out.printf("  | Current Account No.: %s |\n", CAaccNo);
                    ...
                    if (passedTest) {
                        ...
                        while (checker) {
                            ...
                            if (withdrawal_amount <= 20) {
                                System.out
                                        .println(ANSI_RED + "Withdrawal amount have to be bigger than $20.00"
                                                + ANSI_RESET);
                                System.out.print("\nEnter amount to withdraw: $");
                                withdrawal_amount = sc.nextDouble();
                                checker = true;
